...
<p style="txt-align:justify">In 2016, researchers from Google DeepMind, London, UK, published their results related to "<a href="https://arxiv.org/pdf/1509.02971.pdf" class="md-link">Continuos Control with Deep Reinforcement Learning" in ICLR</a>". The learning framework is based on the <b>actor-critic network</b></p> 
